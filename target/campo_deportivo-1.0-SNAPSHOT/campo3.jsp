<%-- 
    Document   : campo3
    Created on : 7 jul. 2023, 00:43:25
    Author     : Kenyi Lagos
--%>
...
<html>
    ...
    <section class="campo">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="text-center">CAMPO <strong>3</strong></h2>
                </div>
            </div>
            <div class="row mt-3 mb-4">
                <div class="col-lg-6 d-flex align-items-center">
                    <h3 class="lh-sm">
                      Es un sistema amplio y abierto, que al mismo tiempo pueda ser disfrutado sin contar con una condición atletica profesional. Este es el fútbol 8. Cada equipo cuenta con 8 jugadores. Este campo cuenta con las siguientes medidas: 
Medida de 30 x 50 metros. 
                    </h3>
                </div>
                <div class="col-lg-6 d-flex align-items-center">
                    <img src="imagenes/campo3.png" class="w-100"/>
                </div>
            </div>
        </div>
    </section>
