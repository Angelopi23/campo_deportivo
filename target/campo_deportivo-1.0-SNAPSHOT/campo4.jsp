...
<html>
    ...
    <section class="campo">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="text-center">CAMPO <strong>4</strong></h2>
                </div>
            </div>
            <div class="row mt-3 mb-4">
                <div class="col-lg-5 d-flex align-items-center">
                    <h3 class="lh-sm">
                        El fútbol 7 es un intermedio entre el fútbol 11 y el fútbol 5 o fútbol rápido. Tal como lo indica su nombre, requiere un máximo de 7 jugadores por equipo (el mínimo son 5 jugadores), incluyendo al portero. Este campo cuenta con las siguientes medidas: Medida de 25 x 45 metros. 
           
                    </h3>
                </div>
                <div class="col-lg-7 d-flex align-items-center">
                    <img src="imagenes/campo4.png" class="w-100"/>
                </div>
            </div>
        </div>
    </section>
