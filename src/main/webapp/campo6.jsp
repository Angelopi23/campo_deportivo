<%-- 
    Document   : campo6
    Created on : 12/07/2023, 12:54:18 AM
    Author     : USUARIO
--%>
...
<html>
    ...
    <section class="campo">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="text-center">CAMPO <strong>6</strong></h2>
                </div>
            </div>
            <div class="row mt-3 mb-4">
                <div class="col-lg-5 d-flex align-items-center">
                    <h3 class="lh-sm">
                        El fútbol 5 mas conocido como fulbito por ser una cancha chica, ena medida reglamentaria entre 20 a 30 metros. Una cancha de 600 metros cuadrados.       
           
                    </h3>
                </div>
                <div class="col-lg-7 d-flex align-items-center">
                    <img src="imagenes/campo6.png" class="w-100"/>
                </div>
            </div>
        </div>
    </section>
