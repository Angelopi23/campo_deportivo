<%-- 
    Document   : campo2
    Created on : 7 jul. 2023, 00:41:34
    Author     : 
--%>
...
<html>
    ...
    <section class="campo">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="text-center">CAMPO <strong>2</strong></h2>
                </div>
            </div>
            <div class="row mt-3 mb-4">
                <div class="col-lg-6 d-flex align-items-center">
                    <h3 class="lh-sm">
                      El fútbol 9 támbien es el más practicado que consiste en dos equipos de 9 jugadores cada uno. Las dimensiones del campo en el fútbol 9 pueden variar, pero generalmente se juega en un terreno de juego más pequeño que un campo de fútbol estándar. Este campo cuenta con las siguientes medidas:  
                      Medida de 40 x 60 metros.
                    </h3>
                </div>
                <div class="col-lg-6 d-flex align-items-center">
                    <img src="imagenes/campo2.jpg" class="w-100"/>
                </div>
            </div>
        </div>
    </section>
