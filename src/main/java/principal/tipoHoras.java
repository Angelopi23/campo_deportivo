...
public class tipoHoras extends reserCampo{
  ...
  private Conexion_Datos cn;
    ...
    public tipoHoras(int id_horas, int id,String campo_seleccionado ,String nombres, String apellidos,String dni, String celular, int id_turno, String hora, String total_pagar, String fecha, int id_horario, String forma_pago,String captura_img) {
  ...
  public HashMap h_horas(){
    HashMap<String,String> h= new HashMap();
        ...
        while(consulta.next()){
            h.put(consulta.getString("id"), consulta.getString("hora"));
        }
        cn.cerrar_conexion();
